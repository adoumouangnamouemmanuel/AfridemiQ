...
class StudyPlanService {
    async createStudyPlan(data) {
        try {
            ...
            throw error instanceof ApiError ? error : new ApiError(500, "Failed to create study plan");
        }
  async getStudyPlanById(id) {
            try {
                const studyPlan = await StudyPlan.findById(id)
                    ...
                    .populate("progressTracking.completedTopics progressTracking.weakAreas progressTracking.strongAreas", "name")
                ...
                throw error instanceof ApiError ? error : new ApiError(500, "Failed to retrieve study plan");
            }
        }
  ...
  async updateStudyPlan(id, data) {
            try {
                ...
                throw error instanceof ApiError ? error : new ApiError(500, "Failed to update study plan");
            }
        }
  ...
  async deleteStudyPlan(id) {
            try {
                ...
                throw error instanceof ApiError ? error : new ApiError(500, "Failed to delete study plan");
            }
        }
    }
}
