...
const UserSchema = new Schema({
  ...
  subscription: {
    ...
    expiresAt: Date,
    paymentStatus: { type: String, enum: ['active', 'pending', 'failed'], required: true },
    trialPeriod: {
      startDate: Date,
      endDate: Date,
    },
  ...
  preferences: {
    ...
    preferredContentFormat: { type: String, enum: ['video', 'text', 'audio', 'mixed'], default: 'text' },
  ...
  onboardingStatusId: { type: Schema.Types.ObjectId, ref: 'OnboardingStatus' },
}, { timestamps: true });
...
const ExamSchema = new Schema({
  ...
  examFormat: { type: String, enum: ['paper', 'computer', 'hybrid'], required: true, default: 'paper' },
