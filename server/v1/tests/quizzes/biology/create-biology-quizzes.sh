...
echo "Creating 3 Biology Cell Biology and Organization quizzes..."

for i in {1..3}; do
  echo "Creating Biology quiz $i..."
...
echo "All Biology quizzes created successfully!"